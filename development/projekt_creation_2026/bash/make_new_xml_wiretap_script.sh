...
wiretap_template_name="wiretap_create_node_template.sh"
path_to_wiretap_template="$path_to_bash_dir/$wiretap_template_name"

wiretap_file_name="wiretap_create_node.sh"
path_to_wiretap_file="$path_to_bash_dir/$wiretap_file_name"

wiretap_backup_name="$wiretap_file_name.$(date '+%Y_%m_%d-%H_%M_%S').bak"
path_to_wiretap_backup="$path_to_bak_dir/$pr_version/$wiretap_backup_name"
...
cp -v "$path_to_wiretap_file" "$path_to_wiretap_backup"
cp -v "$path_to_xml_file" "$path_to_xml_backup"

# Copy the template to a new file
cp -v "$path_to_wiretap_template" "$path_to_wiretap_file"
...
sed -i "s/\$WORKSTATION/juliet/g; s/\$NICKNAME/${project_nickname}/g" "$path_to_wiretap_file"
