...
class WidgetAspectRatio(QLineEdit):
    def __init__(self, parent=None):
        ...
        self.setText(self.get_default_aspect_ratio())
        self.setReadOnly(False)

    def get_widget_parameters(self):
        widget_parameters = {
            "widget_name": "template_aspect_ratio",
            "widget_type": "QLineEdit",
            "widget_label_name": "Aspect Ratio: ",
            "widget_default_value": self.get_default_aspect_ratio(),
    ...
    def get_default_aspect_ratio(self):
        """
        Reads the JSON file and returns the default aspect ratio.
        """
        ...
        try:
            with open(json_file_path, 'r') as file:
                data = json.load(file)
            aspect_ratio = data.get("Aspect Ratio: ")
            return aspect_ratio
        except:
