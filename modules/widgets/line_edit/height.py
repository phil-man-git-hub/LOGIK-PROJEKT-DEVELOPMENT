...
class WidgetHeight(QLineEdit):
    def __init__(self, parent=None):
        super().__init__(parent)
        
        # Set object name if needed
        self.setObjectName("template_height")

        # Set default properties
        self.setText(self.get_default_height())
        self.setReadOnly(False)

    def get_widget_parameters(self):
        widget_parameters = {
            "widget_name": "template_height",
            "widget_type": "QLineEdit",
            "widget_label_name": "Height: ",
            "widget_default_value": self.get_default_height(),
