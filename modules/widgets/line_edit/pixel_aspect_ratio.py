...
# File Name:        pixel_aspect_ratio.py
# Version:          2.0.0
# Created:          2024-01-19
# Modified:         2024-12-31
...
class WidgetPixelAspectRatio(QLineEdit):
    def __init__(self, parent=None):
        super().__init__(parent)
        
        # Set object name if needed
        self.setObjectName("template_pixel_aspect_ratio")

        # Set default properties
        self.setText(self.get_default_pixel_aspect_ratio())
        self.setReadOnly(False)

    def get_widget_parameters(self):
        widget_parameters = {
            "widget_name": "template_pixel_aspect_ratio",
            "widget_type": "QLineEdit",
            "widget_label_name": "Pixel Aspect Ratio: ",
            "widget_default_value": self.get_default_pixel_aspect_ratio(),
    ...
    def get_default_pixel_aspect_ratio(self):
        """
        Reads the JSON file and returns the default pixel aspect ratio.
        """
