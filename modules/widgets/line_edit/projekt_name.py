...
class WidgetProjektName(QLineEdit):
    def __init__(self, parent=None):
        super().__init__(parent)
        
        # Set object name if needed
        self.setObjectName("template_name")

        # Set default properties
        self.setPlaceholderText("Projekt Name Will be Dynamically Calculated...")
    ...
    def get_widget_parameters(self):
        widget_parameters = {
            "widget_name": "template_name",
            "widget_type": "QLineEdit",
            "widget_label_name": "Projekt Name: ",
            "widget_default_value": "",
            "widget_placeholder_value": "Projekt Name Will be Dynamically Calculated...",
            "widget_item_values": "",
