...
# File Name:        storage_aspect_ratio.py
# Version:          0.9.9
# Created:          2024-01-19
# Modified:         2024-08-31
...
class WidgetStorageAspectRatio(QLineEdit):
    def __init__(self, parent=None):
        super().__init__(parent)
        
        # Set object name if needed
        self.setObjectName("template_storage_aspect_ratio")

        # Set default properties
        self.setText(self.get_default_storage_aspect_ratio())
        self.setReadOnly(False)

    def get_widget_parameters(self):
        widget_parameters = {
            "widget_name": "template_storage_aspect_ratio",
            "widget_type": "QLineEdit",
            "widget_label_name": "Storage Aspect Ratio: ",
            "widget_default_value": self.get_default_storage_aspect_ratio(),
    ...
    def get_default_storage_aspect_ratio(self):
        """
        Reads the JSON file and returns the default storage aspect ratio.
        """
        ...
        try:
            with open(json_file_path, 'r') as file:
                data = json.load(file)
            storage_aspect_ratio = data.get("Storage Aspect Ratio: ")
            return storage_aspect_ratio
        except:
