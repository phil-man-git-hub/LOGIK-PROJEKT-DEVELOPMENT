...
# Launcher Script for:   centrik_initial_install_2027_romeo
# Script Creation Date:  2025-11-17 20:23:45

the_projekt_name="centrik_initial_install"

the_projekt_flame_name="centrik_initial_install_2027_romeo"
...
the_flame_first_run_log_dir="/PROJEKTS/centrik_initial_install/cfg/log"
...
launch_opt_2="-J centrik_initial_install_2027_romeo"
...
flame_startup_script_dir="/var/opt/Autodesk/flame/projects/centrik_initial_install_2027_romeo/setups"
