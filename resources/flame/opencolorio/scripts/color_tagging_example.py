...
# File Name:        color_tagging_example.py
# Version:          0.0.1
# Created:          2024-01-19
# Modified:         2024-08-31
...
# Set the metadata with color tagging/identity
metadata = ocio.InfoMetadata()
metadata.setAttribute("Copyright", "© 2024 Your Name or Company. All rights reserved.")
metadata.setAttribute("ColorTag", "Primary Correction")
metadata.setAttribute("Identity", "Transform for Scene 1")
