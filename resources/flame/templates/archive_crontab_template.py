...
archive_script_path = "LogikProjektDirectories/LogikProjektDirectory/flame/archives/ArchiveScriptName"  # TESTING

# Define the path for the cron log file
archive_script_cron_log_path = "LogikProjektDirectories/LogikProjektDirectory/flame/archives/FlameWorkstationName/cron_log/LogikProjektName_cron_log.log"  # TESTING
...
class CronJobApp(QWidget):
    ...
    def initUI(self):
        self.setWindowTitle('Schedule Archive Script Cron Job')
        ...
        self.log_label = QLabel(
            ...
            f'  {archive_script_cron_log_path}\n\n')
        ...
        self.submit_button = QPushButton('Schedule Archive Script Job')
...
def create_crontab_entry(script_path, cron_time):
    ...
    cron_command = f"{cron_time} {script_path} >> {archive_script_cron_log_path} 2>&1"
    ...
    print(f"Crontab entry for {script_path} created successfully.")
    print(f"Cron activity will be logged to: {archive_script_cron_log_path}")
