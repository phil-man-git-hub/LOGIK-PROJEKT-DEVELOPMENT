...
# File Name:        change_colorspace_to_texture_paint.py
# Version:          0.0.1
# Created:          2024-11-08
# Modified:        
...
def change_colorspace_to_texture_paint():
    """
    Change the colorspace of selected 'Read' nodes in Nuke to 'texture_paint'.
    This function iterates through all currently selected nodes in Nuke,
    checks if they are of the class 'Read', and sets their colorspace to 'texture_paint'.
