...
# File Name:        remove_init_macos_invisible_files.sh.sh
# Version:          0.9.9
# Created:          2024-01-19
# Modified:         2024-11-04
...
target_directory="/home/pman/workspace/GitHub/flamelogik/LOGIK-PROJEKT-DXS"

# Remove files that begin with '._'
find . -type f -name "._*" -delete

echo "Removed files that begin with '._' in every subdirectory of $target_directory."
