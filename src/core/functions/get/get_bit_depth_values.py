#!/usr/bin/env python3
# -------------------------------------------------------------------------- #
# Filename:     get_bit_depth_values.py
# Purpose:      Retrieves bit depth values from a JSON configuration file.
# Description:  This script reads a predefined list of bit depth options
...
def get_bit_depth_values() -> list[str]:
    return get_json_data(
        GetApplicationPaths.BIT_DEPTH_LIST_VALUES,
