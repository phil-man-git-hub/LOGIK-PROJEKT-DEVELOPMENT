#!/usr/bin/env python3
# -------------------------------------------------------------------------- #
# Filename:     get_cache_float_values.py
# Purpose:      Retrieves float cache values from a JSON configuration file.
# Description:  This script reads a predefined list of float cache options
...
def get_cache_float_values() -> list[dict]:
    return get_json_data(GetApplicationPaths.CACHE_FLOAT_LIST_VALUES)
