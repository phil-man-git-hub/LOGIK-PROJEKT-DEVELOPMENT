#!/usr/bin/env python3
# -------------------------------------------------------------------------- #
# Filename:     get_frame_rate_values.py
# Purpose:      Retrieves frame rate values from a JSON configuration file.
# Description:  This script reads a predefined list of frame rate options
...
def get_frame_rate_values() -> list[str]:
    return get_json_data(
        GetApplicationPaths.FRAME_RATE_LIST_VALUES,
