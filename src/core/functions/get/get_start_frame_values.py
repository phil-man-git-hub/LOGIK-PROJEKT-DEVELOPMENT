#!/usr/bin/env python3
# -------------------------------------------------------------------------- #
# Filename:     get_start_frame_values.py
# Purpose:      Retrieves start frame values from a JSON configuration file.
# Description:  This script reads a predefined list of start frame options
...
def get_start_frame_values() -> list[str]:
    return get_json_data(
        GetApplicationPaths.START_FRAME_LIST_VALUES,
