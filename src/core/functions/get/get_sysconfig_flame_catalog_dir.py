#!/usr/bin/env python3
# -------------------------------------------------------------------------- #
# Filename:     get_sysconfig_flame_catalog_dir.py
# Purpose:      Retrieves the default Flame catalog directory from sysconfig.
# Description:  This script reads the sysconfig.cfg file to obtain the
#               predefined default path for Flame project catalog directories.
...
def get_sysconfig_flame_catalog_dir() -> str:
    """
    Load default Flame catalog directory from configuration.

    Returns:
        Default catalog directory path string
    """
    sysconfig_cfg_path = GetApplicationPaths.SYSCONFIG_CFG
    default_path = "<project home>/catalog"
    ...
    try:
        ...
        return (
            ...
            .get("settings", {})
            .get("project_folders", {})
            .get("default_catalog_dir", default_path)
        )
