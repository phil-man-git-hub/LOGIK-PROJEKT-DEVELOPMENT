#!/usr/bin/env python3
# -------------------------------------------------------------------------- #
# Filename:     get_sysconfig_flame_setups_dir.py
# Purpose:      Retrieves the default Flame setups directory from sysconfig.
# Description:  This script reads the sysconfig.cfg file to obtain the
#               predefined default path for Flame project setups directories.
...
def get_sysconfig_flame_setups_dir() -> str:
    """
    Load default Flame setups directory from configuration.

    Returns:
        Default setups directory path string
    """
    sysconfig_cfg_path = GetApplicationPaths.SYSCONFIG_CFG
    default_path = "<project home>/setups"
    ...
    try:
        ...
        return (
            ...
            .get("settings", {})
            .get("project_folders", {})
            .get("default_setups_dir", default_path)
        )
