#!/usr/bin/env python3
# -------------------------------------------------------------------------- #
# Filename:     flame_media_dir_widget.py
# Purpose:      Provides a button widget to select the Flame media directory.
...
class FlameMediaDirWidget(QWidget):
    def __init__(self, master=None, command=None):
        ...
        self.label = QLabel("Flame Media Dir:")
        ...
        self.button.setObjectName("flameMediaDirButton")
