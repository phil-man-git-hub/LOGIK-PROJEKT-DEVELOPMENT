#!/usr/bin/env python3
# -------------------------------------------------------------------------- #
# Filename:     flame_setups_dir_widget.py
# Purpose:      Provides a button widget to select the Flame setups directory.
...
class FlameSetupsDirWidget(QWidget):
    def __init__(self, master=None, command=None):
        ...
        self.label = QLabel("Flame Setups Dir:")
        ...
        self.button.setObjectName("flameSetupsDirButton")
