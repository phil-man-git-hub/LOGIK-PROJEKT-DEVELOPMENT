#!/usr/bin/env python3
# -------------------------------------------------------------------------- #
# Filename:     bit_depth_widget.py
# Purpose:      Provides a widget for bit depth selection.
# Description:  A QComboBox widget for selecting the bit depth.
