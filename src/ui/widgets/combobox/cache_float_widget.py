#!/usr/bin/env python3
# -------------------------------------------------------------------------- #
# Filename:     cache_float_widget.py
# Purpose:      Provides a widget for float cache selection.
# Description:  A QComboBox widget for selecting the float cache format.
...
class CacheFloatWidget(QWidget):
