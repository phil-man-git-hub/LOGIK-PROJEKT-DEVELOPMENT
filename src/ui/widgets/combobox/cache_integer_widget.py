#!/usr/bin/env python3
# -------------------------------------------------------------------------- #
# Filename:     cache_integer_widget.py
# Purpose:      Provides a widget for integer cache selection.
# Description:  A QComboBox widget for selecting the integer cache format.
...
class CacheIntegerWidget(QWidget):
    def __init__(self, master=None):
        ...
        self.label = QLabel("Cache Integer:")
