#!/usr/bin/env python3
# -------------------------------------------------------------------------- #
# Filename:     frame_rate_widget.py
# Purpose:      Provides a widget for frame rate selection.
# Description:  A QComboBox widget for selecting the frame rate.
