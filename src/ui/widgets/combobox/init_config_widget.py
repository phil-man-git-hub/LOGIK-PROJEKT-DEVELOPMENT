#!/usr/bin/env python3
# -------------------------------------------------------------------------- #
# Filename:     init_config_widget.py
# Purpose:      Provides a widget for init config selection.
# Description:  A QComboBox widget for selecting the init config.
...
class InitConfigWidget(QWidget):
