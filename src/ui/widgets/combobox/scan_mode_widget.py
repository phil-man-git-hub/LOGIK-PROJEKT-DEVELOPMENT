#!/usr/bin/env python3
# -------------------------------------------------------------------------- #
# Filename:     scan_mode_widget.py
# Purpose:      Provides a widget for scan mode selection.
# Description:  A QComboBox widget for selecting the scan mode.
