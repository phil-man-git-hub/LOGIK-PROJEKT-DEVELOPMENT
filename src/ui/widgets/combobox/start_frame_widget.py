#!/usr/bin/env python3
# -------------------------------------------------------------------------- #
# Filename:     start_frame_widget.py
# Purpose:      Provides a widget for start frame selection.
# Description:  A QComboBox widget for selecting the start frame.
...
class StartFrameWidget(QWidget):
