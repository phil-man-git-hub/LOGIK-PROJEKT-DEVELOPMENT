#!/usr/bin/env python3
# -------------------------------------------------------------------------- #
# Filename:     aspect_ratio_widget.py
# Purpose:      Displays the calculated aspect ratio.
# Description:  A read-only widget to show the aspect ratio based on resolution.
...
class AspectRatioWidget(QWidget):
    def __init__(self, master=None):
        ...
        self.label = QLabel("Aspect Ratio:")
