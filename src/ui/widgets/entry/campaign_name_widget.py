#!/usr/bin/env python3
# -------------------------------------------------------------------------- #
# Filename:     campaign_name_widget.py
# Purpose:      Provides a widget for campaign name input.
# Description:  A simple QLineEdit widget for entering the campaign name.
...
class CampaignNameWidget(QWidget):
    def __init__(self, master=None):
        ...
        self.label = QLabel("Campaign Name:")
