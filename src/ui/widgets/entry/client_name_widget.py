#!/usr/bin/env python3
# -------------------------------------------------------------------------- #
# Filename:     client_name_widget.py
# Purpose:      Provides a widget for client name input.
# Description:  A simple QLineEdit widget for entering the client name.
...
class ClientNameWidget(QWidget):
