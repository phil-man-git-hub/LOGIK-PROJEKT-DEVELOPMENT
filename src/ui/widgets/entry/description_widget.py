#!/usr/bin/env python3
# -------------------------------------------------------------------------- #
# Filename:     description_widget.py
# Purpose:      Provides a widget for description input.
# Description:  A simple QLineEdit widget for entering an optional description.
