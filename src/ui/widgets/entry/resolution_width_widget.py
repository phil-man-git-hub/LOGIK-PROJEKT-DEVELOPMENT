#!/usr/bin/env python3
# -------------------------------------------------------------------------- #
# Filename:     resolution_width_widget.py
# Purpose:      Displays the resolution width.
# Description:  A read-only widget to show the resolution width.
...
class ResolutionWidthWidget(QWidget):
