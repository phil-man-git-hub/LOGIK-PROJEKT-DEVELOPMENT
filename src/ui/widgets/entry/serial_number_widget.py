#!/usr/bin/env python3
# -------------------------------------------------------------------------- #
# Filename:     serial_number_widget.py
# Purpose:      Provides a widget for serial number input.
# Description:  A simple QLineEdit widget for entering an optional serial number.
...
class SerialNumberWidget(QWidget):
    def __init__(self, master=None):
        ...
        self.label = QLabel("Serial Number:")
