...
from tmp.unused.src.utils.pyside6_qt_print import (
...
def pyside6_qt_refresh_hooks(script_name: Optional[str]='') -> None:
    '''
    ...
    Example:
        ...
        pyside6_qt_refresh_hooks('Script Name')
    '''
    ...
    pyside6_qt_print(script_name, 'Python hooks refreshed.')
